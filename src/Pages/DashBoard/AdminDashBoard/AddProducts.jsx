...
const AddProducts = () => {
  ...
  const handleSubmit =async (event) =>{
    ...
    const productsName = from.name.value;
    ...
    const Alldata = {
        brand,Category,price,description,imageData
    }
   try{
   axios.post('http://localhost:5000/products',Alldata)
    ...
    return (
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-6 gap-x-3 gap-y-4">
