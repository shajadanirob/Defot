        ...
        <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="p-5">
                ...
                <form className="w-full space-y-5">
                    ...
                    <input name="name" type="text" autocomplete="email" required=""
                        className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1"
                        placeholder="Your name" value=""/>
                    <label for="email" className="sr-only">Image</label>
                    <input name="image" type="file" autocomplete="email" required=""
                        className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm outline-none placeholder:text-gray-400 focus:ring-2 focus:ring-black focus:ring-offset-1"
                ...
                <div className="mt-6 text-center text-sm text-slate-600">
                    You have an allready account?
                    <Link to='/login' className="font-medium text-[#4285f4]">Login now</Link>
                </div>
            </div>
        </div>
    </div>
